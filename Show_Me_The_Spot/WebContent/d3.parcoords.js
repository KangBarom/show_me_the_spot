...
function brushUpdated(newSelection) {
	...
	var legend
	 	d3.select("#count_legend")
	    .style("color", "red")
	    .text(function() { return "data count is -> " + newSelection.length});  
  ...
  function brushFor(axis) {
    ...
    brush
      ...
      .on("brush", function() {
    	 ...
    	 // console.log("brush_axis name is -> "+axis);
    	 //(parseFloat(d.distance)>198) ? 570-(parseFloat(d.distance)*168/166) : null;
    	 //(axis
